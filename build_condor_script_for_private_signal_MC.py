...
cmd += "Transfer_Input_Files = run_the_cmsRun_commands.sh, TEMPLATE_LHE_GEN_SIM_cfg.py, TEMPLATE-RunIISummer16DR80Premix-DIGIPREMIXRAW_cfg.py, TEMPLATE-RunIISummer16DR80Premix-RECO_cfg.py, TEMPLATE-RunIISummer16MiniAODv2-MINIAODSIM_cfg.py, %s\n" % (infile)

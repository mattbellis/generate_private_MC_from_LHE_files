...
# with command line options: step1 --filein file:TEMPLATE-RunIISummer16DR80Premix-RECO.root --fileout file:TEMPLATE-RunIISummer16MiniAODv2-MINIAODSIM.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 4 --era Run2_2016 --python_filename TEMPLATE-RunIISummer16MiniAODv2-MINIAODSIM_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n -1
...
filename = 'file:{0}-RunIISummer16MiniAODv2-MINIAODSIM.root'.format(filetag)

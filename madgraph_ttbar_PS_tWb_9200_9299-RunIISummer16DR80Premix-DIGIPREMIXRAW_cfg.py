...
# with command line options: step1 --filein file:madgraph_ttbar_PS_tWb_9200_9299_GEN_SIM.root --fileout file:madgraph_ttbar_PS_tWb_9200_9299-RunIISummer16DR80Premix-DIGIPREMIXRAW.root --pileup_input dbs:/Neutrino_E-10_gun/RunIISpring15PrePremix-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v2-v2/GEN-SIM-DIGI-RAW --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:@frozen2016 --nThreads 4 --datamix PreMix --era Run2_2016 --python_filename madgraph_ttbar_PS_tWb_9200_9299-RunIISummer16DR80Premix-DIGIPREMIXRAW_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n -1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:madgraph_ttbar_PS_tWb_9200_9299_GEN_SIM.root'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:madgraph_ttbar_PS_tWb_9200_9299-RunIISummer16DR80Premix-DIGIPREMIXRAW.root'),

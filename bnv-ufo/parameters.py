...
aaaprime = Parameter(name = 'aaaprime',
                     nature = 'external',
                     type = 'real',
                     value = 0.,
                     texname = '\\text{aaaprime}',
                     lhablock = 'FRBlock',
                     lhacode = [ 6 ])

bbbprime = Parameter(name = 'bbbprime',
                     nature = 'external',
                     type = 'real',
                     value = 0.,
                     texname = '\\text{bbbprime}',
                     lhablock = 'FRBlock',
                     lhacode = [ 7 ])

cccprime = Parameter(name = 'cccprime',
                     nature = 'external',
                     type = 'real',
                     value = 0.,
                     texname = '\\text{cccprime}',
                     lhablock = 'FRBlock',
                     lhacode = [ 8 ])

dddprime = Parameter(name = 'dddprime',
                     nature = 'external',
                     type = 'real',
                     value = 0.,
                     texname = '\\text{dddprime}',
                     lhablock = 'FRBlock',
                     lhacode = [ 9 ])
